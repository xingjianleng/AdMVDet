...
class MVDet(MultiviewBase):
    def __init__(self, dataset, arch='resnet18', aggregation='max',
                 use_bottleneck=True, hidden_dim=128, outfeat_dim=0, rl_variant="conv_base", z=0, seed=0, log_std=1.):
        ...
        if dataset.base.__name__ == "CarlaX" and dataset.interactive:
            ...
            self.control_module = CamControl(action_dim, hidden_dim, rl_variant, 3, aggregation, seed=seed, log_std=log_std)
